...
const DEEP_TOPOLOGY: DiscussionRound[] = [
  ...
  { round: 3, experts: ['Sentiment Analyst', 'Risk Manager', 'Contrarian Strategist'], parallel: true, dependsOn: [2] },
  { round: 4, experts: ['Professional Reviewer'], parallel: false, dependsOn: [3] },
  { round: 5, experts: ['Chief Strategist'], parallel: false, dependsOn: [4] },
];

const STANDARD_TOPOLOGY: DiscussionRound[] = [
  { round: 1, experts: ['Deep Research Specialist'], parallel: false, dependsOn: [] },
  { round: 2, experts: ['Technical Analyst', 'Fundamental Analyst', 'Risk Manager'], parallel: true, dependsOn: [1] },
  { round: 3, experts: ['Professional Reviewer'], parallel: false, dependsOn: [2] },
  { round: 4, experts: ['Chief Strategist'], parallel: false, dependsOn: [3] },
];
